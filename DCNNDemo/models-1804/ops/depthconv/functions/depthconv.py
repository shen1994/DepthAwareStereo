...
def depth_conv(input,
    ...
    if isinstance(bias, torch.nn.Parameter):
        # print(f(input, depth, weight, bias).shape)
    ...
    def forward(self, input, depth, weight, bias = None):
        ...
        if not input.is_cuda:
            ...
            if not isinstance(input, torch.cuda.FloatTensor):
                raise NotImplementedError
            _depthconv_ext.depthconv_forward_cuda(
    ...
    def backward(self, grad_output):
        ...
        if not grad_output.is_cuda:
            ...
            if self.needs_input_grad[0]:
                ...
                _depthconv_ext.depthconv_backward_input_cuda(
            ...
            if self.needs_input_grad[2]:
                ...
                _depthconv_ext.depthconv_backward_parameters_cuda(
