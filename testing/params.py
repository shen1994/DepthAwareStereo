...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--label_nc', type=int, default=2, help='# of input image channels')
        ...
        self.parser.add_argument('--colorjitter', type=int, default=0, help='if specified, crop the images for data argumentation')
        ...
        self.parser.add_argument('--nepochs', type=int, default=2000, help='# of iter at starting learning rate')
        self.parser.add_argument('--lr', type=float, default=0.0025, help='initial learning rate for adam') # 0.00025
